...
Размер буфера по умолчанию принимался равным 5555 байт:

```
int buf_size = 5555;
```

Результаты выполнения программы на описанных выше 5 тестах можно увидеть тут [тут](https://github.com/kamilarakhimova/hse-os-hw1/tree/main/4%20балла/Результаты).
