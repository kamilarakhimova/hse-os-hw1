...
Здесь процесс 1 (родитель-файловик) читает текстовые данные из заданного файла и через именованный канал 'channel 1.fifo' передает их второму процессу.
Процесс 2 (родитель-обработчик) осуществляет обработку данных в соответствии с заданием и передает результат обработки через именованный канал 'channel 2.fifo' обратно первому процессу.
А процесс 1 (родитель-файловик) осуществляет вывод данных в заданный файл.
...
*здесь будет картинка-результат*
